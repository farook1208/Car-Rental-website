...
function CarsFiltersOption({carsList,setBrand,orderCarList}:any) {
  ...
  return (
    <div className='mt-10 flex items-center justify-between'>
        <div>
            <h2 className='text-[30px] font-bold bg-white rounded-full p-1 px-5'>Cars Catalog</h2>
            <h2 className='text-pink-500'>Explore our cars you might likes</h2>
        </div>
        <div className='flex gap-5'>
            ...
            select-bordered w-full md:block max-w-xs hidden text-white"
